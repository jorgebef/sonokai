...
function! sonokai#get_palette(style) "{{{
  ...
  elseif a:style ==# 'atlantis'
     let palette = {
          \ 'black':      ['#181a1c',   '237',  'DarkGrey'],
          \ 'bg0':        ['#272c35',   '235',  'Black'],
          \ 'bg1':        ['#303541',   '236',  'DarkGrey'],
          \ 'bg1_5':        ['#323743',   '236',  'DarkGrey'],
          \ 'bg2':        ['#373c4b',   '236',  'DarkGrey'],
          \ 'bg3':        ['#3d4455',   '237',  'DarkGrey'],
          \ 'bg4':        ['#424b5b',   '237',  'Grey'],
          \ 'bg5':        ['#535c68',   '237',  'Grey'],
          \ 'bg6':        ['#596370',   '237',  'Grey'],
          \ 'bg_search':     ['#8f8f8f',   '203',  'Red'],
          \ 'bg_red':     ['#dd828b',   '203',  'Red'],
          \ 'diff_red':   ['#473536',   '52',   'DarkRed'],
          \ 'bg_green':   ['#a6bf56',   '107',  'Green'],
          \ 'diff_green': ['#384034',   '22',   'DarkGreen'],
          \ 'bg_blue':    ['#9cd6f5',   '110',  'Blue'],
          \ 'diff_blue':  ['#323e47',   '17',   'DarkBlue'],
          \ 'fg_original':         ['#e1e3e4',   '250',  'White'],
          \ 'fg':         ['#dcdfe3',   '250',  'White'],
          \ 'red':        ['#ff6578',   '203',  'Red'],
